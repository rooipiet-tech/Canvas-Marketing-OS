...
@secure()
@description('Part 0 of 4 -- the SAME bundle JSON gatekeeper-app.bicep receives, built by main.bicep. Split across four params, never one, so no single base64-encoded value approaches ARM template-expression literal limit -- see main.bicep, comment above gatekeeperBundlePart0.')
