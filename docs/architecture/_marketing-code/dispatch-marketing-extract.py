# EXTRACT — the marketing code of Canvas Marketing OS
#
# Source: services/orchestrator/orchestrator/dispatch.py
# This is a READ-ONLY extract for analysis. Do not edit; edit the source.
# Original line numbers are preserved in the section banners below.
#
# This file contains every line of executable marketing domain logic in
# the platform. Nothing in the other 20,800 lines of non-test Python
# knows what marketing is.


# ==========================================================================
# SHARED — constants and client factories
# dispatch.py lines 62-232
# ==========================================================================
...
# ==========================================================================
# SHARED — prompt read, JSON parse, complete+meter
# dispatch.py lines 235-317
# ==========================================================================
...
# ==========================================================================
# HANDLER-SPECIFIC — ingest redaction fallback
# dispatch.py lines 320-399
# ==========================================================================
...
# ==========================================================================
# SHARED — depends_on lineage resolution
# dispatch.py lines 402-440
# ==========================================================================
...
# ==========================================================================
# HANDLER 1 of 5 — ingest-signals   (fn 09, haiku)
# dispatch.py lines 443-558
# ==========================================================================
...
# ==========================================================================
# HANDLER 2 of 5 — draft-brief      (no LLM)
# dispatch.py lines 561-677
# ==========================================================================
...
# ==========================================================================
# HANDLER 3 of 5 — qa-review        (fn 02, sonnet)
# dispatch.py lines 680-856
# ==========================================================================
...
# ==========================================================================
# HANDLER 4 of 5 — draft-content    (fn 42, sonnet)
# dispatch.py lines 859-949
# ==========================================================================
...
# ==========================================================================
# HANDLER 5 of 5 — request-approval (no LLM)
# dispatch.py lines 952-1023
# ==========================================================================
