...
migration files — the 27 previously cited here predates the options-inbox
v2, orchestrator, and `mcp_ops` additions; see
`20-multi-tenancy-decision-memo.md` §1.1 for the re-derivation).
