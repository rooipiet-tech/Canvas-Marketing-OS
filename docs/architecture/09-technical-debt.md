...
> second model charge it enabled); TD-16 (`resolve_live_fqdn`'s three
> hand-duplicated copies — a new `services/azure-client-lib` package,
> mirroring governance-lib's own extraction).
