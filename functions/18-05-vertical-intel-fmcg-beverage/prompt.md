...
## Vertical watchlist - FMCG & Beverage

`docs/positioning.md` section 4 records this vertical's proof shape as a
beverage group consolidating multiple bottling and distribution entities
across currencies - described generically here, never by name, per the
client-naming rule above. Watch for: FMCG/beverage-sector ERP consolidation
and multi-currency reporting tenders; beverage-sector CFO commentary on
reconciliation cycles across bottling entities; and BI/analytics vendor
movement targeting FMCG finance teams.
