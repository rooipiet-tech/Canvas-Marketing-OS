...
for function 18-05-vertical-intel-fmcg-beverage.
...
HEADLINES = (
    "A beverage group's public results commentary cited multi-entity, "
    "multi-currency consolidation as a stated reporting cost",
    "An FMCG-sector analytics vendor announced a bottling-plant finance-reporting module",
    "A beverage-sector ERP consolidation tender named "
    "multi-currency intercompany matching as a scored requirement",
    "A beverage-group CFO was quoted describing a different "
    "number for the same question across bottling entities",
)

SO_WHATS = (
    "Multi-currency consolidation across bottling entities mirrors "
    "the exact pain Canvas's consolidation-at-scale pillar answers",
    "A bottling-plant finance module is a vertical-competitor signal "
    "worth tracking against Canvas's own beverage-sector proof",
    "A tender scoring intercompany matching validates this "
    "vertical's demand for exactly Canvas's positioning",
    "A CFO quote on a different number for the same question is "
    "CFO-office pain language worth citing verbatim in a proof post",
)

SOURCE_POOL = (
    "https://www.businesslive.co.za/fmcg",
    "https://www.itweb.co.za/article/fmcg-tenders",
